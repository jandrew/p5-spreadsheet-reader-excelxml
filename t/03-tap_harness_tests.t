...
my	@tests =(
		...
		[  $dir . $tests . 'ExcelXML/XMLReader/01-extract_file.t', 'xmlreader_extract_file_test' ],
		[  $dir . $tests . 'ExcelXML/05-cell_to_column_row.t', 'cell_to_column_row_test' ],
		[  $dir . $tests . 'ExcelXML/11-xml_to_perl_data.t', 'xml_to_perl_test' ],
		[  $dir . $tests . 'ExcelXML/07-fmt_default.t', 'default_format_test' ],
		[  $dir . $tests . 'ExcelXML/08-parse_excel_fmt_string.t', 'excel_format_string_test' ],
		[  $dir . $tests . 'ExcelXML/12-format_interface.t', 'format_interface_test' ],
		[  $dir . $tests . 'ExcelXML/13-sharedstrings_interface.t', 'shared_strings_interface_test' ],
		[  $dir . $tests . 'ExcelXML/15-styles_interface.t', 'styles_sheet_test' ],
		[  $dir . $tests . 'ExcelXML/16-worksheet_to_row.t', 'worksheet_to_row_test' ],
		[  $dir . $tests . 'ExcelXML/10-worksheet.t', 'worksheet_test' ],
		[  $dir . $tests . 'ExcelXML/09-cell.t', 'cell_test' ],
		[  $dir . $tests . '01-ExcelXML.t', 'workbook_test' ],
		[  $dir . $tests . 'ExcelXML/52-merge_function_alignment.t', 'merged_areas_test' ],
		[  $dir . $tests . 'ExcelXML/20-empty_sharedstrings_bug.t', 'empty_sharedstrings_bug' ],
		...
		[  $dir . $tests . 'ExcelXML/81-text_in_worksheet_bug.t', 'text_in_worksheet_bug' ],
		[  $dir . $tests . 'ExcelXML/91-quote_in_style_line_bug.t', 'quote_in_styles_bug' ],
		[  $dir . $tests . '08-open_spreadsheet_ml_files.t', 'open_xml_files' ],
		[  $dir . $tests . '09-open_MySQL_data.t', 'open_MySQL_files' ],
		[  $dir . $tests . 'ExcelXML/97-dxfId_handling_bug.t', 'dxfId_handling_bug' ],
	);
use	TAP::Harness;
